...
很多工具解决的是“下载”。拾图 更关注下载之前的那一步：判断哪些图片值得留下。
...
拾图 的方式是：每个站点单独适配，页面内轻量选择，后台统一下载。
...
进入 `chrome://extensions`，找到「拾图」，点击刷新按钮。
...
拾图 想做的是一件朴素的事：让认真收集图片的人，少一点重复操作，多一点判断和创造的时间。
